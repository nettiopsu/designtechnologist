---
title: "Searching for yourself"
image: ../images/searching-for-yourself.svg
aspectRatio: 0.72204617474
order: 1
description:
  "Not a surprise that Design Technologists often begin with searching for
  themselves at the start of their career"
references:
  [
    {
      text:
    ...
    {
      text: "Quartz, Growth Engineer",
      href: "https://angel.co/company/quartz-an-atlantic-media-company/jobs/500426-growth-engineer",
    },
  ]
---

This handbook is trying to find a standard definition for the design
technologist, describe hybrid professions, explore the job market, explain
benefits and challenges that Design Technologists can cope with, and compare it
to other nearby professions.
